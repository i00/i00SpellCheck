...
#Region "Dictionary Functions"
    ...
    Public Sub DictionaryIgnoreWord(ByVal Word As String)
        CurrentDictionary.Add(Word, True)
    ...
    Public Sub DictionaryRemoveWord(ByVal Word As String)
        Dim NoApoS = Dictionary.Formatting.RemoveApoS(Word)
        For Each item In (From xItem In CurrentDictionary Where LCase(xItem.Entry) = LCase(Word) OrElse LCase(xItem.Entry) = LCase(NoApoS))
        ...
        For Each iSellClassWithSameDict In AllControlsWithSameDict()
            'remove item from cache
            For Each item In (From xItem In iSellClassWithSameDict.dictCache Where LCase(xItem.Key) = LCase(Word) OrElse LCase(xItem.Key) = LCase(NoApoS)).ToArray
