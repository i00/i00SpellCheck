...
#Region "Check that Word is in the Dictionary"
        ...
        Public Function SpellCheckWord(ByVal Word As String) As SpellCheckWordError
            ...
            'Strip 's
            Dim OldWord = theWord
            theWord = SpellCheckTextBox.RemoveApoS(theWord)
            ...
            For Each iDicWord In DicWords
                ...
                If iDicWord.Entry = LCase(iDicWord.Entry) Then
                    ...
                    If iDicWord.ItemState = SpellCheckTextBox.Dictionary.DictionaryItem.eItemState.Ignore Then
...
#Region "Word Breaks"
    ...
    Private Shared mc_WordBreakChrs As String()
    Friend Shared ReadOnly Property WordBreakChrs() As String()
        Get
            If mc_WordBreakChrs Is Nothing Then
                '                                End chrs                                     Angled",                  Generic                   , Start chrs           Angled"        
                mc_WordBreakChrs = New String() {".", ",", ";", ":", "?", "!", ")", "]", "}", Chr(146) & " ", Chr(148), """", "/", "\", vbCr, vbLf, "(", "[", "{", " '", " " & Chr(145), Chr(147), "-"}
            End If

            Return mc_WordBreakChrs
        End Get
    End Property
