...
#End Region
        ...
        Public Function FindWord(ByVal Word As String, Optional ByVal DictionaryForBaseWord As Dictionary = Nothing, Optional ByVal HTMLColorForQuotes As String = "") As WordDefinition
            ...
            If FileIO.FileSystem.FileExists(File) Then
                ...
                If FindWord.Count = 0 Then
                    ...
                    Else
                        Dim BaseWord = DictionaryForBaseWord.FindBaseWord(Word.ToLower)
        ...
        Public Class WordDefinition
            ...
            Public BaseType As Dictionary.FindBaseWordReturn.BaseTypes = Dictionary.FindBaseWordReturn.BaseTypes.None
            ...
            Public Overrides Function ToString() As String
                If Me.Count > 0 Then
                    ...
                    If BaseType <> Dictionary.FindBaseWordReturn.BaseTypes.None Then
                        Dim FindBaseWordReturn As New Dictionary.FindBaseWordReturn
